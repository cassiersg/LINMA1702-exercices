...
\begin{enumerate}
  ...
  \item On considère le problème diététique suivant:
    ...
    \begin{solution}
      ...
      marché à des prix de 1 et 0.5, le problème du primal devient
      \begin{align*}
    ...
    \begin{solution}
      ...
      \begin{enumerate}
        \item Soit $a_{ij}$, le gain réel de Jacques.
          ...
          $$\sum_{i=1}^{m}x_{i}\sum_{j=1}^{n}y_{j}a_{ij}$$
        \item Si Yvan veut maximiser son gain,
          ...
          \begin{align*}
            ...
            0 & \leq \sum_{j}^{n} y_{j} \leq 1\\
            0 & \leq y_{j} \leq 1 & j = 1, \dots, n.
          \end{align*}
        \item Pour maximiser son gain,
          Yvan doit choisir 1, 2 et 3 avec une probabilité de 0, 1 et 0.
          Soit les deux joueurs choisissent en même temps 2 auquel cas
          le gain est nul,
          soit Yvan joue 2 et Jacques 3 auquel cas Yvan remporte 3 EUR.
          Le gain espéré est de 1.5 EUR.
          Dans les autres stratégies, le gain espéré
          de Jacques est plus faible.
        \item Si on se limite au cas particulier du (c),
          il faudra que Jacques choisisse tout le temps 1.
          Le gain espéré est dans ce cas de 3 EUR.
          Formellement, le problème devient
          \begin{align*}
            \max_x \sum_{i=1}^{m}x_{i}\sum_{j=1}^{n}y_{j}a_{ij}\\
            0 & \leq \sum_{i}^{n} x_{i} \leq 1\\
            0 & \leq x_{i} \leq 1 & j = 1, \dots, n.
          \end{align*}
      \end{enumerate}
    \end{solution}
