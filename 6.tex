...
\begin{enumerate}
  ...
  \item On considère le problème diététique suivant:
    ...
    \begin{solution}
      ...
      $$ y_{1} + y_{2} \le 10$$
      $$y_{i} \geq 0$$
      En effectuant l'algorithme du simplexe pour le dual, on obtient $y^{*} = (\frac{1}{9},\frac{13}{9})$. Par le principe d'exclusion, il faut nécessairement que $Ax = b$. On obtient $x^{*} = A^{-1}b = (1,2,0)$. En conclusion, la vitamine $B$ est la plus chère. \\
