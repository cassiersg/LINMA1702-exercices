...
\begin{enumerate}
  ...
  \item Trouvez le dual du problème
    ...
    \begin{solution}
      $$ max ~3y_{1} -3y_{2} + 2y_{2} - 8y_{4}$$
      $$ 4y_{1} -4y_{2} + y_{3} -y_{4} \le 3$$
      $$ -y_{1} +y_{2}-y_{3}+4y_{4} \le -9$$
      $$ y_{1} -y_{2}-6y_{3} +6y_{4} \le 0$$
      $$-y_{1} +y_{2} +6y_{3}-6y_{4} \le 0$$
      $
      \begin{array}{lrcr}
        \maxi & 3y_1 + 2y_2 + 8y_3\\
  ...
  \item Trouvez une formulation duale du  problème
    ...
    \begin{solution}
      $$max~b^{T}y_{1} + a^{T}y_{2}$$
      $$A^{T}y_{1} + Iy_{2} = c$$
      $$y_{1}~libre ~et~y_{2} \geq0$$
  ...
  \item Trouvez une formulation duale du  problème
    ...
    \begin{solution}
      $$max~ b_{1}^{T}y_{1} + b_{2}^{T}y_{2}$$
      $$A^{T}y_{1} \le c$$
      $$A^{T}y_{2} \le c$$
      $$y_{1} \geq 0 ~et ~y_{2} \le 0$$
    \end{solution}
  ...
  \item Comment résoudre le problème
    ...
    \begin{solution}
      Dual : \\
      $$max~8y_{1} + 19y_{2} +7y_{3}$$
      $$y_{1} + 3y_{2} +3y_{3} \le50$$
      $$3y_{1}+4y_{2}+y_{3}\le 25$$
      $$y_{i} \geq0$$
  ...
  \item Soit le problème
    ...
    \begin{solution}
      ...
      $$ y_{i} \geq 0$$
      \newline
      Les contraintes d'inégalités imposent : \\
      $$ \frac{1}{2} \le y_{1} \le \frac{2}{3}$$
      $$ \frac{1}{3} \le y_{2} \le \frac{2}{3}$$
      La fonction coût du dual admet comme borne inférieure $\frac{13}{6}$ et comme borne supérieure $\frac{10}{3}$. \\
      La fonction coût du primal n'admet pas de borne supérieure mais admet $3$ comme borne inférieure.
  ...
  \item L'objectif optimal du problème
    ...
    \begin{solution}
      ...
      $$2y_{1} + 3y_{2} + y_{3} \le 7$$
      $$3y_{1} + 4y_{2} + 2y_{3} \le 10$$
      $$y_{i} \geq 0$$
  ...
  \item Soit le problème suivant
    ...
    \begin{solution}
      ...
      $$ 2y_{1} + y_{2}  + 2y_{3} \le 5$$
      $$ -y_{1} + y_{2}  -y_{3} \le -3$$
      $$ 4y_{1} + 2y_{2}  + y_{3} \le 0$$
      $$y_{i} \geq 0$$
      Solution du primal $x^{*} = (1,2,1)$. Or, par le principe d'exclusion, $x^{*T}(c -A^{T}y) = 0$. Dans ce cas, il faut résoudre le système d'équations suivant : \\
      \[
      \begin{pmatrix}
      2 & 1 & 2\\
      -1 & 1 & -3\\
