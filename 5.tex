    ...
    \begin{solution}
      \begin{enumerate}
          ...
          x_3 & \geq 0\\
           ...
           \item Soit $z*$ le coût optimal du problème de départ. Il suffit alors de transformer la fonction objectif en $\max x_3$ et de rajouter la contrainte $\sum_{i=1}^5 x_i p_i = z*$.\\
           
           \item Cela peut se faire par un raisonnement adéquat. L'énoncé nous dit déjà que $x_3 = 0$ et donc que $x_6 = 0$. L'acheteur B paye le plus donc on lui vend le maximum qu'on peut à savoir $2$ tonnes. Ensuite, l'idéal serait de donner le plus qu'on peut à l'acheteur D et de donner tout le reste au A mais on ne peut pas à cause de la contrainte sur l'acheteur E. Le mieux serait alors de donner aux acheteurs D, E, A respectivement $5$, $2$, $11$ tonnes ou $4$, $1$, $13$ tonnes ou $3$, $0$, $15$ tonnes. On se rend compte que ces 3 solutions donnent en fait le même coût total, il y a donc $3$ solutions optimales qui donnent un coût optimal de $475$. 
      \end{enumerate}
    \end{solution}
